...
public class ChangedActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ChangedActivity";
    ...
    public void settingsClicked(View view) {
        ...
        Intent intent = new Intent(ChangedActivity.this, SettingsActivity.class);
        startActivity(intent);
    }

    private void openSmsApp() {
        String packageName = Telephony.Sms.getDefaultSmsPackage(ChangedActivity.this);
